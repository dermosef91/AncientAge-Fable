...
export const BUILDINGS: Record<BuildingTypeId, BuildingDef> = {
  towncenter: {
    ...
    armor: 2, pop: 5, dropoff: true, trains: ['villager', 'scout'], vision: 9,
  ...
  acropolis: {
    ...
    armor: 3, pop: 5, dropoff: true, trains: ['villager', 'scout'],
  ...
  beacon: {
    name: 'Beacon Hill', cost: {}, hp: 700, size: 2, buildTime: 1, armor: 2, vision: 20, level: 0,
