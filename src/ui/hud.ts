...
import {
  ...
  MARKET_LOT, MARKET_SELL_GOLD, MAX_LEVEL, RES_ORDER, SCOUT, SETTLEMENTS, TECHS, trainableAt,
  UNITS, WILDS, type Cost
} from '../core/config';
import type {
...
export class HUD {
  ...
  private renderPanel() {
    ...
    if (units.length > 1) {
      ...
      else if (bld.type === 'beacon' || bld.type === 'obelisk') sub = landmarkStatus(w, bld);
